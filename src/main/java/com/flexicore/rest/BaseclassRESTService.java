...
@OpenAPIDefinition(
        ...
        @Tag(name = "Access Control", description = "Handle Roles, Tenants and Users, FlexiCore provide fine granularity access to operations, classes and instances"),
        @Tag(name = "Views", description = "Manage Views, Views provide a way to group types (Entities) together for management of their instances creation, update and association"),
        ...
        @Tag(name = "Documentation", description = "REST API related to API documentation via Swagger and Code generation"),
        @Tag(name = "Media", description = "Manage Media Objects"),
        ...
        @Tag(name = "DynamicProperties", description = "Dynamic Properties"),
